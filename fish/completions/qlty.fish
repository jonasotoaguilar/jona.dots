...
complete -c qlty -n "__fish_qlty_needs_command" -f -a "sources" -d 'Manage plugin sources'
...
complete -c qlty -n "__fish_qlty_using_subcommand check" -l skip-source-fetch -d 'Skip fetching sources before running checks'
...
complete -c qlty -n "__fish_qlty_using_subcommand coverage; and __fish_seen_subcommand_from publish" -l selection -d 'Mark this upload as coming from a selected subset of the test suite — e.g. only the tests affected by a pull request\'s changes. Selected coverage contributes to diff coverage only and is excluded from total coverage'
complete -c qlty -n "__fish_qlty_using_subcommand coverage; and __fish_seen_subcommand_from publish" -l skip-source-fetch -d 'Skip fetching sources before publishing. Requires sources to be cached locally'
...
complete -c qlty -n "__fish_qlty_using_subcommand coverage; and __fish_seen_subcommand_from complete" -l selection -d 'Complete the uploads published with --selection. Selected and unselected uploads assemble into separate reports, so pass this exactly when it was passed to qlty coverage publish'
...
complete -c qlty -n "__fish_qlty_using_subcommand fmt" -l skip-source-fetch -d 'Skip fetching sources before formatting'
...
complete -c qlty -n "__fish_qlty_using_subcommand sources; and not __fish_seen_subcommand_from fetch help" -l debug -d 'Log with more information'
complete -c qlty -n "__fish_qlty_using_subcommand sources; and not __fish_seen_subcommand_from fetch help" -l no-upgrade-check -d 'Do not check for updates'
complete -c qlty -n "__fish_qlty_using_subcommand sources; and not __fish_seen_subcommand_from fetch help" -s h -l help -d 'Print help'
complete -c qlty -n "__fish_qlty_using_subcommand sources; and not __fish_seen_subcommand_from fetch help" -f -a "fetch" -d 'Fetch plugin sources'
complete -c qlty -n "__fish_qlty_using_subcommand sources; and not __fish_seen_subcommand_from fetch help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c qlty -n "__fish_qlty_using_subcommand sources; and __fish_seen_subcommand_from fetch" -l debug -d 'Log with more information'
complete -c qlty -n "__fish_qlty_using_subcommand sources; and __fish_seen_subcommand_from fetch" -l no-upgrade-check -d 'Do not check for updates'
complete -c qlty -n "__fish_qlty_using_subcommand sources; and __fish_seen_subcommand_from fetch" -s h -l help -d 'Print help'
complete -c qlty -n "__fish_qlty_using_subcommand sources; and __fish_seen_subcommand_from help" -f -a "fetch" -d 'Fetch plugin sources'
complete -c qlty -n "__fish_qlty_using_subcommand sources; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c qlty -n "__fish_qlty_using_subcommand upgrade; and not __fish_seen_subcommand_from source help" -l verify-attestations -d 'Verify SLSA provenance attestation before installing'
...
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "auth" -d 'Manage authentication'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "build" -d 'Run an analysis build'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "cache" -d 'Manage cache'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "check" -d 'Run linters'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "completions" -d 'Generate or install Qlty CLI shell completions'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "config" -d 'Print current version'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "coverage" -d 'View, transform, and publish code coverage'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "dashboard" -d 'Open the Qlty Cloud dashboard in the browser'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "deinit" -d 'Remove Qlty from the current repository'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "discord" -d 'Join our Discord server (opens in the browser)'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "docs" -d 'Open the docs website in the browser'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "fmt" -d 'Auto-format files by rewriting them'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "githooks" -d 'Manage Git hooks'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "init" -d 'Set up Qlty in the current repository'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "install" -d 'Install linters and their dependencies'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "metrics" -d 'Compute code quality metrics'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "panic" -d 'Intentionally panic to test crash handling'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "parse" -d 'Parse source code'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "patch" -d 'Apply patches from check'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "plugins" -d 'Manage plugins'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "smells" -d 'Find code smells like duplication and complexity'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "sources" -d 'Manage plugin sources'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "telemetry" -d 'Send telemetry'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "upgrade" -d 'Upgrade the Qlty CLI'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "validate" -d 'Validate the project'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "version" -d 'Print the current Qlty CLI version'
complete -c qlty -n "__fish_qlty_using_subcommand help; and not __fish_seen_subcommand_from auth build cache check completions config coverage dashboard deinit discord docs fmt githooks init install metrics panic parse patch plugins smells sources telemetry upgrade validate version help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c qlty -n "__fish_qlty_using_subcommand help; and __fish_seen_subcommand_from sources" -f -a "fetch" -d 'Fetch plugin sources'
