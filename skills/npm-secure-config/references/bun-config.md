...
Version gates verified against official Bun docs and release notes (re-verified 2026-08-12). Always confirm with the installed `bun --version` before applying.
