...
Version gates verified against `pnpm.io/settings` (re-verified 2026-08-12) and the upstream README. Always confirm with the installed `pnpm --version` before applying.
