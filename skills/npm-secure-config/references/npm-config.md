...
Version gates verified against npm release notes, `docs.npmjs.com/cli/v11/using-npm/config`, and `docs.npmjs.com/cli/v12/configuring-npm/package-json` (re-verified 2026-08-12). Always confirm with the installed `npm --version` before applying.
...
Run it before installs in CI (job wiring is `ci-cd-and-automation`'s domain; this skill owns the check commands).
