...
> Syntax reference for diagnosis only. PR create/update/merge and public comments execute through the owning skills:
> `branch-pr` (create/update), `merge-pr` (merge), `comment-writer` (comments/reviews).
