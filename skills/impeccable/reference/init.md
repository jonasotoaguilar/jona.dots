...
- Existing coherent interface without DESIGN.md: `/impeccable document` if the user wants the incumbent system's visual evidence captured independently of a new build.
