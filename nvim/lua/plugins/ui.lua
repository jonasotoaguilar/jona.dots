...
return {
  ...
  -- Description: A blazing fast and easy to configure Neovim statusline plugin.
  {
    ...
    opts = {
      options = {
        theme = "auto", -- Toma los colores del colorscheme activo (catppuccin mocha)
  ...
  -- Description: A Neovim plugin for creating a customizable dashboard.
  {
    ...
    opts = {
      ...
      image = {},
      explorer = {
        git_status = true, -- Iconos de estado git en archivos y directorios (como lazygit)
        layout = {
          icon = {
            git_status_hl = true, -- Colorea el nombre del archivo según su estado git
          },
        },
      },
      picker = {
...
⠀⠀⠀⠀⣸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
  ...
  {
    -- Dashboard header en morado claro (catppuccin mauve)
    "folke/snacks.nvim",
    init = function()
