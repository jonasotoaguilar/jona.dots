...
-- Mostrar TODOS los diagnósticos de la línea (warnings/hints incluidos), on-demand
...
end, { desc = "Diagnósticos de la línea (todos)" })

-- Find files con cambios git (estilo lazygit: M/A/D/? con colores)
vim.keymap.set("n", "<leader>fG", function()
  Snacks.picker.git_status()
end, { desc = "Archivos con cambios (git status)" })
